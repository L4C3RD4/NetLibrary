       ...
       <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Relatórios de Listagem de Reservas Solicitadas<small></small>
                        </h1>
                        ...
                        <div id="filtros_relatorio"> 
                            ...
                            <h3 class="page-header">
                                <input type="radio" name="tiporel" value="geral">Toda a Lista de Reservas <small></small> 
                                 </h3>
        ...
        <div id="rel_leg">
         ...
         <div class="col-xs-12">            
             <h3></h3>             
             <div id="empty_leg"><label>Não existem Reservas Solicitadas</label></div>
             <!--<h3 style="display:inline;">- SeguranÃ§a e eficiÃªncia nas suas transaÃ§Ãµes finaceiras</h3>-->                          
         </div>                                    
     
        <table id="tblrel_reservas" class="table table-striped table-bordered" cellspacing="0" width="100%" >
         ...
         <div class="col-xs-12">
            ...
            <script src="<?php echo base_url(); ?>utils/js/ajax/relatorios/rel_reservas.js"></script>            
                        <!--
                        <ol class="breadcrumb">
                            <li class="active">
