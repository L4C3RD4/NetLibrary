...
<br />
    ...
    <div class="col-md-12 column">
        <div class="modal fade" id="NecessarioFazerLogin" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                     ...
                     <form method="post">
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                                 <h4 style="text-align: center;">É necessário realizar login para reservar este material!</h4>
                             </div>
...
<script src="<?php echo base_url(); ?>utils/js/ajax/pesquisa.js"></script>