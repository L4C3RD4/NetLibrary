<div id="page-wrapper">         
    ...
    <div class="col-xs-4">                                            
         <button type="button" class="btn btn-success" id="btcadastrarConfiguracao">
			<span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Cadastrar Configurações
         </button>   
    </div>
</center>
...
<script src="<?php echo base_url(); ?>utils/js/ajax/configuracoes_biblioteca_gestor.js"></script>
