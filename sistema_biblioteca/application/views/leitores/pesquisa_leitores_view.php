<div id="page-wrapper"> 
    <div class="fluid-container">
        ...
        <div class="col-lg-12">
           ...
           <div class="col-lg-12">
        <h1 class="page-header">PESQUISA AOS ACERVOS DAS BIBLIOTECAS</h1>
    </div>
        <div id="pesquisa">
...
<option value="910 – GEOGRAFIA ">910 – GEOGRAFIA </option>
    ...
    <div class="col-md-12 column">
        <div class="modal fade" id="cadastrarReserva" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                 <div class="modal-dialog">
                     <form method="post">
                         <div class="modal-content">
                             <div class="modal-header">
                                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                                 <h4 class="modal-title" id="myModalLabel-reserva">
                                     Deseja realizar a reserva deste material?
                                 </h4>
                             </div>
                             <div class="modal-body">
                                    <?php
                                    ...
                                    ?>
                                 <form role="form" method="post" action="reserva_controller/cadastar_reserva" name="cadastrar_reserva">
                                 <input type="hidden" id="idreserva" name="idreserva" />
                                 <input type="hidden" id="material" name="material" />
                                 <input type="hidden" id="acervo" name="acervo" />
                                 <input type="hidden" id="biblioteca" name="biblioteca" />
                                 <input type="hidden" id="status_acervo_biblioteca" />
                                 <input type="hidden" class="form-control" id="data_solicitacao" value="<?php echo date('Y/m/d'); ?> ">
                                 <input type="hidden" class="form-control" id="data_vencimento" value="<?php echo date('Y/m/d', strtotime("+ 1 day"));?> ">
                                <input type="hidden" id="leitor" name="leitor" value="<?php echo $session_data['idusuario']; ?>">
                                 <div class="col-xs-12">
                                     <label id="titulo_material">Material</label>
                                 </div>
                                 <div class="col-xs-12">
                             ...
                             <br><br><br><div class="modal-footer">
                                 <button type="button" class="btn btn-default fechar" data-dismiss="modal" id="btFecharReserva">Fechar</button>
                                 <input type="button" id="btCadastrarReserva" class="btn btn-primary" value="Realizar Reserva" />
                             </div>
                         </div>
                     </form>
                 </div>
