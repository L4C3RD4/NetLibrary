...
//                        $biblioteca = $session_data["biblioteca"];
                    ...
                    ?>
                    <h1 class="page-header">Painel do Leitor</h1>
                </div>
<!--                    <div class="row">
         Modal       
        <div class="col-lg-12">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="acervos_cadastrados"></div>
                                    <div> Materiais Cadastrados no Sistema</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="reservas_solicitadas"></div>
                                    <div>Reservas Solicitadas por Você</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="bibliotecas"></div>
                                    <div>Bibliotecas Disponíveis</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="acervos_empregados"></div>
                                    <div>Materiais em Situação de Empréstimos</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
...
<!--                                <span class="pull-left">View Details</span>
        ...
        <script src="<?php echo base_url(); ?>utils/js/ajax/estatisticas_leitor.js"></script>
